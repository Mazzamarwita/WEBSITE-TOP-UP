    ...
    function(card) {
        ...
        card.addEventListener(
            ...
            function() {
                ...
                console.log(
                    "Item Zenless Zone Zero dipilih:",
                    selectedItem
                );
    ...
    payButton.addEventListener(
        ...
        function() {
            ...
            if (
                ...
                alert(
                    "Silakan masukkan UID Zenless Zone Zero!"
                );
...
if (continuePaymentButton) {
    ...
    continuePaymentButton.addEventListener(
        ...
        function() {
            ...
            console.log(
                "Transaksi Zenless Zone Zero dibuat:",
                transactionData
            );
