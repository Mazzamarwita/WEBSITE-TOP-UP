...
// Tombol voucher
const voucherAction =
    document.querySelector(".voucher-action");
...
// ==========================================
// 15. PILIH ITEM / GENESIS CRYSTALS
// ==========================================
    ...
    payButton.addEventListener(
        ...
        function() {
            ...
            if (
                ...
                alert(
                    "Silakan masukkan UID Genshin Impact!"
                );
...
if (continuePaymentButton) {
    ...
    continuePaymentButton.addEventListener(
        ...
        function() {
            ...
            console.log(
                "Transaksi Genshin Impact dibuat:",
                transactionData
            );
